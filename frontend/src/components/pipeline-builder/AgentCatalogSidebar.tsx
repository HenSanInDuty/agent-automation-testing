...
export function AgentCatalogSidebar() {
    ...
    const [expandedGroups, setExpandedGroups] = useState<Set<string>>(
        new Set(['special', 'ingestion', 'testcase', 'execution', 'reporting']),
    );
    ...
    // Flatten grouped agents
    const allAgents = groupedAgents
        ? [
              ...(groupedAgents.ingestion || []),
              ...(groupedAgents.testcase || []),
              ...(groupedAgents.execution || []),
              ...(groupedAgents.reporting || []),
          ]
        : [];
        ...
        <div className="w-64 border-r border-zinc-700 bg-zinc-900 flex flex-col overflow-hidden">
            ...
            <div className="flex-1 overflow-y-auto p-2 space-y-1">
                {Object.entries(filteredGroups).map(([stage, items]) => (
                    <div key={stage}>
                        ...
                        >
                            ...
                            {stageLabelMap[stage] || (stage.charAt(0).toUpperCase() + stage.slice(1))}
                ...
                {Object.keys(filteredGroups).length === 0 && (
                    <p className="text-xs text-zinc-500 text-center py-4">No agents found</p>
                )}
            </div>
